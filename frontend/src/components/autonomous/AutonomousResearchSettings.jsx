    ...
    <div className="autonomous-settings-layout">
      ...
      <div className="settings-left-sidebar">
        <div className="known-models-sidebar">
          <h3>📦 Tested Compatible Models</h3>
          <div className="models-list">
            ...
            <div className="model-item" style={{ 
              ...
              <div className="model-item-badge">Very fast, cheap, higher knowledge than OSS 20B</div>
              <div className="model-item-note">(outputs may corrupt over time)</div>
            </div>
            ...
            <div className="model-item" style={{ 
              ...
              <div className="model-item-badge">Good validator</div>
            </div>
            ...
            <div className="model-item" style={{ 
              ...
              <div className="model-item-badge">Great writer, cheap, moderate to fast speed</div>
            </div>
            ...
            <div className="model-item">
              ...
              <div className="model-item-badge">Highly knowledgeable, expensive</div>
            </div>
            
            <div className="model-item">
              <div className="model-item-name">DeepSeek V3.2 Speciale</div>
              <div className="model-item-badge">Even better writer, higher knowledge, slower</div>
            </div>
            
            <div className="model-item">
              <div className="model-item-name">Gemini 3.0 Pro</div>
              <div className="model-item-badge">Very expensive, slower, knowledgeable</div>
            </div>
            
            <div className="model-item">
              <div className="model-item-name">Gemini Flash 2.5</div>
              <div className="model-item-badge">Validator</div>
            </div>
            
            <div className="model-item">
              <div className="model-item-name">Gemini Flash 2.5 Light</div>
              <div className="model-item-badge">Cheaper validator</div>
            </div>
            
            <div className="model-item">
              <div className="model-item-name">Gemini Flash 3.0 Preview</div>
              <div className="model-item-badge">Great validator - expensive</div>
            </div>
            
            <div className="model-item">
              <div className="model-item-name">GPT OSS 20B</div>
              <div className="model-item-badge">Very fast and cheap</div>
              <div className="model-item-note">(outputs may corrupt over time)</div>
            </div>
            
            <div className="model-item">
              <div className="model-item-name">Kimi K2</div>
              <div className="model-item-badge">Expensive, slow, very high knowledge</div>
            </div>
            
            <div className="model-item">
              <div className="model-item-name">OpenAI: GPT 5.2</div>
              <div className="model-item-badge">Highly knowledgeable, expensive</div>
            </div>
            
            <div className="model-item">
              <div className="model-item-name">Perplexity: Sonar</div>
              <div className="model-item-badge">Cheap internet search capability</div>
            </div>
          </div>
        </div>
      </div>
